 $(function() {
     ...
     function parseAllData() {
         d3.csv("data.csv", function(data) {
             ...
             generateTable(data);
             generateAttributeBoxData(tableData);
 ...
 function generateAttributeBoxData(tableData) {
         ...
         for (var i = 0; i < attributeList.length; i++) {
             var dataRow = attributeList[i];
             columnArray[i] = "<div class='checkbox'><label><input type='checkbox' value=" + dataRow + "/>" + dataRow + "</label></div> ";
